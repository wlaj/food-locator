...
import PreferencesDropdown from "@/components/preferences-dropdown";
  ...
  return (
    <header className="border-b z-20 fixed top-0 right-0 bg-white w-full">
      ...
      <div className="flex h-14 md:h-16 items-center justify-between gap-2 md:gap-4 px-4 md:px-6">
        {/* Logo */}
        <div className="flex-shrink-0 flex gap-2 items-center md:flex-1">
          ...
          <div className="border-l-2 pl-2 border-border">
            <PreferencesDropdown locations={locations || []} />
          </div>
        </div>
