...
const HowItWorks = async ({ heading, demoUrl, demoTitle }: HowItWorks) => {
  ...
  return (
    <section className="py-8 md:py-12">
      <div className="mb-6 md:mb-8 flex flex-col gap-2 md:gap-4 justify-between lg:mb-16">
        <div>
          <h2 className="mb-3 text-xl font-semibold md:mb-4 md:text-2xl lg:mb-6">
            {heading}
          </h2>
          <a
            href={demoUrl}
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-4 items-stretch">
          ...
          <div className="flex flex-col gap-2 p-4 sm:p-6 rounded-xl border w-full md:w-1/3">
            <IconCircle4 className="size-6 sm:size-8" />
            <h3 className="text-md sm:text-lg font-medium">
